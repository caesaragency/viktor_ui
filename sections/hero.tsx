...
export function HeroVariant1({ restaurant, lang }: HeroProps) {
	...
	return (
		<section id='hero' className='mb-30 h-[700px]'>
			<div className='md:grid md:grid-cols-1 md:gap-12 md:items-start mb-6'>
				{/* Left: Text content */}
				...
				{/* Right: Hero image */}
				<div className='relative h-64 sm:h-80 md:h-96 lg:h-112 w-full overflow-hidden rounded-sm '>
					{heroImage ? (
						<Image
							src={heroImage}
							alt={restaurant.name}
			...
			<div
				className='relative  bottom-118 h-112 w-125'
				style={{ backgroundColor: 'rgba(0, 0, 0, 0.70)' }}
			>
				{description && (
					<p
						className='max-w-md text-[20px] font-semibold leading-relaxed pt-5 pl-15'
						style={
							{
